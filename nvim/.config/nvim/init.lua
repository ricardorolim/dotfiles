...
require('lazy').setup({
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    opts = {
      -- delay between pressin a key and opening which-key (milliseconds)
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    event = 'VimEnter',
    -- TODO:repin the version number once telescope has become compatible with the latest version again
    -- branch = '0.1.x',
    dependencies = {
      ...
      -- Lists snippets for the current filetype
      { 'benfowler/telescope-luasnip.nvim' },

      -- Allow filtering live grep
    ...
    config = function()
      ...
      end, { desc = '[S]search by [G]rep args' })
